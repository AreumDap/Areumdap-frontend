...
class OnboardingCustomKeywordFragment: Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.selectedSeason.observe(viewLifecycleOwner) { season ->
            ...
            binding.tvSelectedSeasonResult.text = Html.fromHtml(seasonTextResult, Html.FROM_HTML_MODE_LEGACY)
            binding.tvKeywordSelectionGuide.text = Html.fromHtml(seasonKeywordGuide, Html.FROM_HTML_MODE_LEGACY)
        }
